(function init() {
	function ready() {
		...
		//OOPS.get(['Aweiss.Test'], ready);
		OOPS.addScripts(["Aweiss.AjaxLoader.AjaxLoader", "Aweiss.AjaxLoader.PageManager", "Aweiss.AjaxLoader.Page", "Aweiss.AjaxLoader.DataManager", 
		...
		OOPS.get(['Aweiss.AjaxLoader.AjaxLoader'], ready);
})();
